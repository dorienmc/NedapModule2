...
class LongestPrefixMatcherAlsoOld extends AbstractPrefixMatcher{
	...
	public static void main(String[] args) {
		...
		new LongestPrefixMatcherAlsoOld();
	}

	/**
	 * Constructs a new LongestPrefixMatcherOld3 and starts routing
	 */
	public LongestPrefixMatcherAlsoOld() {
	...
	private int getBestId(int ip, ArrayList<Integer> partialMatches) {
		...
		for (Integer id : partialMatches) {
			...
			System.out.println(String.format(
					...
					Utils.ipToHuman(routeIp), matchingBits, Utils.ipToHuman(ip),prefixLength));
